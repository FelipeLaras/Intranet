      ...
      <div class="row">
        <div class="span8">
          ...
          $busca = "SELECT 
            ...
            WHERE
              BP.deletar = 0
            ORDER BY id_postagem DESC limit " . $limit . "";
          ...
          <aside>
            ...
            <div class="widget">
              ...
              <ul class="cat">
                ...
                <li><a href="http://rede.paranapart.com.br/ti/" target="_blank">T.I</a></li>
                <li><a href="https://sites.google.com/servopa.com.br/cadastro/home" target="_blank">Cadastro</a></li>
                <li><a href="http://rede.paranapart.com.br/tv/index.php" target="_blank">Peças</a></li>
              </ul>
            </div>
            <div class="widget">
