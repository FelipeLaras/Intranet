...
<head>
    ...
    <!-- Google Analytics -->
   <script async src="https://www.googletagmanager.com/gtag/js?id=UA-118964886-1"></script><script>
        ...
        <div class="container">
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                        ...
                        <ul>
							<li class="drop-down"><a href="#">Consórcio</a>
								<ul>
                                    ...
                                    <li><a href="https://drive.google.com/file/d/104ZK7ONhNdzyvmh6QOrjXMnSS63iEh2P/view" target="_blanck"><p>Manual de Prevenção à Lavagem de Dinheiro</p><p style="font-size: 10px;">(Terceira Edição de 29 de junho de 2020)</p></a></li>
                            ...
                            <li><a href="http://rede.paranapart.com.br/ti">T.I</a></li>
                    ...
                    <li class="drop-down"><a href="">Fábrica</a>
                        <ul>
                            ...
                            <li class="drop-down"><a href="#">Audi</a>
                                <ul>
                                    <li><a href="https://auth.portaltecsinapse.com.br/realms/Audi/protocol/openid-connect/auth?response_type=code&client_id=AudiPortal&redirect_uri=https%3A%2F%2Fciaudibrasil.com.br%2F&state=2802%2F2e849bd2-2ad0-4ca3-9a0a-faa6d92a9099&login=true&scope=openid"
                                            target="_blanck">Portal Audi</a></li>
                                    <li><a href="https://www.group-training-online.com//index.jsp"
                                            target="_blanck">Training</a></li>
                            ...
                            <li class="drop-down"><a href="#">Honda</a>
                                <ul>
                                    <li><a href="http://www.hondaposvenda.com.br/Portal/adm/Account/Index?ReturnUrl=%2fPortal%2fadm%2f"
                                            target="_blanck">Pós vendas Honda</a></li>
                                    <li><a href="https://myhonda.force.com/concessionaria/login?ec=302&inst=61&startURL=%2Fconcessionaria%2Fapex%2FmyHonda_LeadBox%3Fsfdc.tabName%3D01r61000000edb2"
                                            target="_blanck">My Honda</a></li>
                            ...
                            <li class="drop-down"><a href="#">Harley-Davidson</a>
                                <ul>
                                    <li><a href="https://www.harley-davidson.com/br/pt/index.html"
                                            target="_blanck">Harley-Davidson</a>
                                    </li>
                        ...
                        <ul>
                            <li class="drop-down"><a href="#">DETRAN</a>
                                <ul>
                                    ...
                                    <li><a href="http://www.detran.sc.gov.br/informacoes/veiculos"
                                            target="_blank">Detran SC</a></li>
                                    ...
                                    <li><a href="http://www.detran.ap.gov.br/detranap/veiculo/consulta-de-veiculos/"
                                    ...
                                    <li><a href="http://central.detran.ce.gov.br/central_servicos"
                                            target="_blank">Detran CE</a></li>
                                    <li><a href="http://getran.detran.df.gov.br/site/veiculos/consultas/filtroplacarenavam-consultaveiculo.jsp"
                                            target="_blank">Detran DF</a></li>
                                    <li><a href="https://publicodetran.es.gov.br/NovoConsultaVeiculoES.asp"
                                            target="_blank">Detran ES</a>
                                    </li>
                                    <li><a href="https://www.detran.go.gov.br/psw/#/pages/pagina-inicial"
                                            target="_blank">Detran GO</a>
                                    </li>
                                    ...
                                    <li><a href="http://www.detran.ms.gov.br/consulta-de-debitos/"
                                            target="_blank">Detran MS</a></li>
                                    <li><a href="http://www.detran.pa.gov.br/sistransito/detran-web/servicos/veiculos/indexRenavam.jsf"
                                            target="_blank">Detran PA</a></li>
                                    <li><a href="http://detran.pb.gov.br/veiculo/consulta-do-veiculo"
                                            target="_blank">Detran PB</a></li>
                                    ...
                                    <li><a href="http://www.detran.rj.gov.br/_monta_aplicacoes.asp?cod=11&amp;tipo=consulta_multa"
                                            target="_blank">Detran RJ</a></li>
                                    <li><a href="http://www2.detran.rn.gov.br/externo/consultarveiculo.asp"
                                            target="_blank">Detran RN</a>
                                    </li>
                                    <li><a href="https://consulta.detran.ro.gov.br/CentralDeConsultasInternet/Software/ViewConsultaVeiculos.aspx"
                                            target="_blank">Detran RO</a></li>
                                    <li><a href="https://www.rr.getran.com.br/site/apps/veiculo/filtroplacarenavam-consultaveiculo.jsp"
                                            target="_blank">Detran RR</a></li>
                                    <li><a href="https://www.portaldetransito.rs.gov.br/dtw2/app/servico/vei/consulta-veiculo-form.xhtml"
                                            target="_blank">Detran RS</a></li>
                                    <li><a href="https://seguro.detran.se.gov.br/portal/?pg=cons_veiculo"
                                            target="_blank">Detran SE</a>
                                    </li>
                                    <li><a href="https://www.ipva.fazenda.sp.gov.br/IPVANET_Consulta/Consulta.aspx"
                                            target="_blank">Detran
                                            SP</a></li>
                                    <li><a href="http://www.sefaz2.to.gov.br/ipva/extrato_debito.php"
                                            target="_blank">Detran TO</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a href="http://srvctpeugeot306:8080/dianfse/servlet/hnfse0001"
                                    target="_blank">Dianfse</a></li>
                    ...
                    <li style="margin-right: -87px"><a
                            href="https://sites.google.com/a/servopa.com.br/manual-grupo-servopa/home">Manuais /
                            Atualizações</a></li>
                </ul>
            </nav><!-- .main-nav -->
        </div>
        ...
        <section id="about">
            <div class="container">
                <div class="row about-container">
                    <iframe src="info_blog/index.php" height="3650" width="1300" scrolling="no"
                        style="border: dotted 1px #dbd8d8;"></iframe>
                </div>
                <div class="text-left">
                    <div class="plus">
