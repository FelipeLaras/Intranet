...
<?php 
  ...
  $post_query = "SELECT * FROM blog_user WHERE id_user = ".$_GET['id']."";
              ...
              <div class="panel-body">
                <form role="form" method="POST" action="editando_user.php">
                  ...
                  <div class="form-group">
                    ...
                    <input name="nome" type="text" class="form-control" style="width: 40%;" id="login" value="<?= $post['nome'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="email">E-mail: </label>
                    <input name="email" type="text" class="form-control" style="width: 40%;" id="email" value="<?= $post['email'] ?>">
                  </div>                  
                  <div class="form-group">
                    <label for="exibicao">Nome: </label>
                    <input name="exibicao" type="text" class="form-control" style="width: 40%;" id="exibicao" value="<?= $post['exibicao'] ?>">
                  </div>                 
                  <div class="form-group">
                    <label for="senha_atual">Senha: </label>
                    <input name="senha_atual" type="password" class="form-control" style="width: 30%;" id="senha_atual">
                    <input name="senha" type="password" class="form-control" style="display:none;" id="senha" value="<?= $post['senha'] ?>">
                  </div>
                  <div class="form-group">
